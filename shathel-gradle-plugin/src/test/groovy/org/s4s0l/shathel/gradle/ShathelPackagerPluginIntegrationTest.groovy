...
class ShathelPackagerPluginIntegrationTest extends org.s4s0l.bootcker.gradle.utils.GradlePluginFunctionalSpecification {
    ...
    def "Prepares docker context and shathel package"() {
        ...
        file("build/shathel-stack/shthl-stack.yml").text.contains("gav: org.s4s0l.shathel.gradle.sample:simple-project:1.2.3-SNAPSHOT")
        file("build/shathel-stack/stack/docker-compose.yml").text.contains("context: ./dockerfiles/dummyExtra")
        file("build/shathel-stack/stack/docker-compose.yml").text.contains("context: ./dockerfiles/simple-project")
        file("build/shathel-stack/stack/docker-compose.yml").text.contains("dockerfile: Dockerfile2")

        file("build/shathel-stack/stack/dockerfiles/dummyExtra/Dockerfile2").exists()
        file("build/shathel-stack/stack/dockerfiles/simple-project/Dockerfile").exists()

        file("build/shathel-mappings/org_s4s0l_shathel_gradle_sample_simple_project_1_2_3_SNAPSHOT").exists()
