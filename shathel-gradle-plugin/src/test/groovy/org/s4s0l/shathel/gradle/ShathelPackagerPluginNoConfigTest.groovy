...
class ShathelPackagerPluginNoConfigTest extends org.s4s0l.bootcker.gradle.utils.GradlePluginFunctionalSpecification {
    ...
    def "No Config - Prepares docker context and shathel package"() {
        ...
        then:
        noExceptionThrown()
        file("build/shathel-stacks/basic-project/shthl-stack.yml").exists()
        file("build/shathel-stacks/basic-project/shthl-stack.yml").text.contains("gav: org.s4s0l.shathel.gradle.sample:basic-project:1.0-SNAPSHOT")
        !file("build/shathel-stacks/basic-project/stack/dockerfiles/basic-project/Dockerfile").exists()
        file("build/shathel-stacks/org_s4s0l_shathel_gradle_sample_basic_project_1_0_SNAPSHOT").exists()
