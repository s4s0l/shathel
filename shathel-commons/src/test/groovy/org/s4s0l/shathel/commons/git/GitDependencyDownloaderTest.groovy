...
class GitDependencyDownloaderTest extends Specification {
    ...
    def "download dependency"() {
        given:
        GitDependencyDownloader gdd = new GitDependencyDownloader();
...
shathel-stack:
  ...
  dependencies:
    git@github.com/s4s0l/shathel-sample-stacks:child-stack:a173704738d1d1d0e49901db43103795749a53a0@master:"""
        ...
        when:
        def stack5 = new StackLocator(new StackReference("git@github.com/s4s0l/shathel-sample-stacks:child-stack:53b4dad37a11de70e2bcc3196119944b207b0748@master"))
