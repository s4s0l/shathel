 ...
 */
public class StackDescriptionTree {
    ...
    public static class Builder {
        ...
        public StackDescriptionTree build(){
            return new StackDescriptionTree(ImmutableGraph.copyOf(graph), rootNode);
        }
    }
    ...
    public StackDescriptionTree(ImmutableGraph<GraphNode> graph, GraphNode rootNode) {
        this.graph = graph;
        this.rootNode = rootNode;
    }
